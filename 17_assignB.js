...
console.log("-------Employee names and company names working in TCS--------");
...
console.log("-------Employee names and department names working in Finance Department--------");
for (const Employee of array_employess) {
...
console.log("-------Employee details whose names strt with R--------");
for (const Employee of array_employess) {
...
console.log("-------Employee names,company names,salary whose salary is greater than 75000");
for (const Employee of array_employess) {
...
console.log("-------Employee details whose salary greater than 50000 and department is IT are-------");
for (const Employee of array_employess) {
...
console.log("-------Employee details from company Infy are-------");
for (const Employee of array_employess) {
